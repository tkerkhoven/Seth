    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.CharField(choices=[('1A', 'Block 1A'), ('1B', 'Block 2A'), ('2A', 'Block 1B'), ('2B', 'Block 2B'), ('3A', 'Block 3A'), ('3B', 'Block 3B'), ('JAAR', 'Block JAAR')], max_length=16)),
                ('start', models.DateField(default=django.utils.timezone.now)),
                ('end', models.DateField(default=datetime.date(9999, 12, 31))),
            ],
        ),
        ...
        migrations.AlterUniqueTogether(
            name='studying',
            unique_together=set([('person', 'study', 'module_edition')]),
        ),
        migrations.AlterUniqueTogether(
            name='moduleedition',
