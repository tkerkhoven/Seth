    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=b'', max_length=16)),
                ('code_extension', models.CharField(default=b'', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.DateField(default=datetime.date(2017, 9, 18))),
                ('module_code_extension', models.CharField(default=b'', max_length=16)),
                ('start', models.DateField(default=datetime.date(1, 1, 1))),
                ('stop', models.DateField(default=datetime.date(9999, 12, 31))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateField(default=datetime.date(1, 1, 1))),
                ('stop', models.DateField(default=datetime.date(9999, 12, 31))),
                ('role', models.CharField(choices=[(b'T', b'Teacher'), (b'S', b'Student'), (b'A', b'Teaching Assistant'), (b'V', b'Study Advisor')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Study',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, null=True)),
                ('_type', models.CharField(choices=[(b'E', b'Exam'), (b'A', b'Assignment'), (b'P', b'Project')], max_length=1)),
                ('time', models.DateTimeField(default=datetime.datetime(1, 1, 1, 0, 0))),
